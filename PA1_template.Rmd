...
The data has been stored in a .csv file (`r fname`) that must be in the same working directory as this markdown file.
...
+ Mean steps per day = `r meanFormat`
+ Median steps per day = `r medianFormat`

## What is the average daily activity pattern?

Data was reported in 5-minute intervals throughout the 24-hour day, yielding a total of `r 24*12` intervals of data per day.  In order to plot an average day, an average number of steps must be found for each interval throughout the study period.  This is accomplished with the following R code.
...
The busiest period is at `r maxPeriod`
...
```
+ Mean steps per day = `r adjMeanFormat`
+ Median steps per day = `r adjMedianFormat`
